...
namespace testlib.Wrapper
{
    internal static class Lib
    {
        ...
        public static extern EepromResult EepromInitDebug(byte[] buffer, UInt32 words_on_page, UInt32 pages_count);
        ...
        public static extern EepromResult EepromReadValue(UInt16 key, ref UInt16 value);
        ...
        public static extern EepromResult EepromWriteValue(UInt16 key, UInt16 value);

        public enum EepromResult : int
        {
            Success = 0,
            ReadFailed = 1,
            NoEmptyPage = 2,
